...
# xres-to-terminator.py
# A script that converts Xresources themes to the format used by Terminator.
#
# Author: Stolid <https://crunchbang.org/forums/viewtopic.php?id=28193>
